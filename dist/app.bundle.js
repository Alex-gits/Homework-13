...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _newsServiceModule__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./newsServiceModule */ \"./newsServiceModule.js\");\n/* harmony import */ var _uiModule__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./uiModule */ \"./uiModule.js\");\n\n\nvar newsService = Object(_newsServiceModule__WEBPACK_IMPORTED_MODULE_0__[\"newsServiceModule\"])();\nvar form = document.forms['newsControls'];\nvar countrySelect = form['country'];\nvar searchInput = form['search'];\ndocument.addEventListener('DOMContentLoaded', function () {\n  M.AutoInit();\n  Object(_uiModule__WEBPACK_IMPORTED_MODULE_1__[\"showLoader\"])();\n  loadNews();\n  newsService.source(_uiModule__WEBPACK_IMPORTED_MODULE_1__[\"createSourceOptions\"]);\n});\nform.addEventListener('submit', function (e) {\n  e.preventDefault();\n  Object(_uiModule__WEBPACK_IMPORTED_MODULE_1__[\"showLoader\"])();\n\n  if (searchInput.value) {\n    newsService.everything(searchInput.value, onGetResponse);\n  } else {\n    newsService.topHeadlines(countrySelect.value, onGetResponse);\n  }\n});\n\nfunction loadNews() {\n  newsService.topHeadlines(countrySelect.value, onGetResponse);\n}\n\nfunction onGetResponse(err, res) {\n  Object(_uiModule__WEBPACK_IMPORTED_MODULE_1__[\"hideLoader\"])();\n\n  if (err) {\n    console.warn(err);\n    return;\n  }\n\n  if (!res.articles.length) {\n    M.toast({\n      html: 'Новости по вашему запросу не найдены!'\n    });\n    return;\n  }\n\n  Object(_uiModule__WEBPACK_IMPORTED_MODULE_1__[\"renderNews\"])(res.articles);\n}\n\n//# sourceURL=webpack:///./app.js?");
